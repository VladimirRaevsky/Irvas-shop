...
var forms = function forms() {
  ...
  var postDate = function postDate(url, date) {
    var res;
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postDate('assets/server.php', formDate).then(function (res) {
        console.log(res);
...
var modals = function modals() {
  ...
  bindModal('.phone_link', '.popup', '.popup_engineer .popup_close'); // showModalByTime('.popup', 60000);
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, classActive) {
